...
const NavButton = ({
  ...
  return (
    <button
      onClick={handleClick}
      className="w-full h-full bg-transparent border-none rounded-lg cursor-pointer text-white transition duration-300 text-left pl-5 flex items-center justify-center gap-8 p-5 hover:bg-[#ffffff18]"
    >
